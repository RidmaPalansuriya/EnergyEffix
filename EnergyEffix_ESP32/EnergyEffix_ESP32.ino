...
// WiFi credentials
const char* ssid = "SLT-LTE-WiFi-600C";
const char* password = "GY85DEB8J12";
// Google script ID and required credentials
String GOOGLE_SCRIPT_ID = "AKfycbyBfGKguly_sZJvcmA6Xi9gEMgrYNCVJFreWoQ3SPfDUKYs2XuwwyeVF6XNwDB0xspA";    
